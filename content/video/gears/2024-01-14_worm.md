...
We then choose a "path + guide rail sweep". The profile is the tooth
profile we just drew, the path is the vertical line, and the guide
rail is the helix. (Make sure "chain selection" is off when selecting
these.)
